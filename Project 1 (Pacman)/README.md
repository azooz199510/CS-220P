...
All the setup instructions are inside [documentation/setup.md](https://github.com/YousefRajeh/CS-220P/blob/main/Project%201%20(Pacman)/documentation/setup.md)
